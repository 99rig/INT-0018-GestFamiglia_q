<template>
  <div class="document-scanner-container">
    ...
    <!-- Scanner buttons -->
    <div v-if="!scanning && showButtons" class="scanner-buttons">
      ...
      <q-btn
        ...
        class="mcf-btn-secondary q-mb-md"
        size="lg"
        no-caps
        unelevated
        rounded
    ...
    <div v-if="scanning" class="scanning-indicator">
      <q-card class="mcf-card q-pa-lg text-center">
        <q-circular-progress
          indeterminate
          size="50px"
          color="mcf-primary"
          class="q-mb-md"
        />
        <div class="text-h6 text-mcf-primary">Scansione in corso...</div>
        <div class="text-caption text-mcf-accent">{{ scanningMessage }}</div>
        
        <q-btn
          label="Annulla"
          @click="cancelScan"
          class="mcf-btn-secondary q-mt-md"
          flat
          no-caps
        />
      </q-card>
